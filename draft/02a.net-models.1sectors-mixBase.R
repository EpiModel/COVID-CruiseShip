...
target.stats1.post <- c(edges.post, edges.post/md.post)
...
target.stats2.post <- c(edges.post)
...
target.stats3 <- c(edges.post, 0)

formation3.post <- ~edges + nodematch("type")
...
saveRDS(est.post, file = "est/est.post.1sector-mixBase.rds")
