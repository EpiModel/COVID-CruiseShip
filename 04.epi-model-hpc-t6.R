...
param <- param.net(inf.prob.pp = 0.1,
                   ...
                   act.rate.dx.inter.rr = DII, #0.1,
                   act.rate.dx.inter.time = DXTIME,
                   act.rate.sympt.inter.rr = SII, #0.1,
                   act.rate.sympt.inter.time = DXTIME,
                   ...
                   ipic.rate = 1/1.5,
                   icr.rate = 1/3.5,
                   dx.rate.sympt = rep(0.5, 100),
                   dx.rate.other = dx.vec,
                   allow.rescreen = TRUE,
                   mort.rates = mr_vec,
                   mort.dis.mult = 100,
                   exit.rate.pass = 0,
